...
alter user U1_SVY_PDB quota unlimited on t1;
alter user U1_SVY_PDB quota unlimited on t2;
alter user U1_SVY_PDB quota unlimited on t3;
alter user U1_SVY_PDB quota unlimited on t4;
